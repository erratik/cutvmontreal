...
class Widget_ContusVideosWidget_init extends WP_Widget {
  ...
  function Widget_ContusVideosWidget_init() {
  	global $wpdb;
    ...
    parent::__construct ( 'Widget_ContusVideosWidget_init', 'Contus Video Widgets', $widget_ops );
...
<?php 
  ...
  function widget($args, $instance) {
    ...
    $userId = get_current_user_id();
    $watchLaterVideoIds = $this->getWatchLaterVideoIds($userId);
