...
$notificationImage = (json_decode($notification->user_content,true)[PROFILE_IMAGE] != '' && file_exists(APPTHA_VGALLERY_BASEDIR. "/images/channel/banner/profile/".json_decode($notification->user_content,true)[PROFILE_IMAGE])) ? APPTHA_VGALLERY_BASEURL. $profile_path.json_decode($notification->user_content,true)[PROFILE_IMAGE] : APPTHA_VGALLERY_BASEURL. "images/channel/".$notification_image;
...
$channelPageLink = channelPageLink();
foreach($notificationDetails as $notification) {
$notificationImage = (json_decode($notification->user_content,true)[PROFILE_IMAGE] != '') ? APPTHA_VGALLERY_BASEURL. $profile_path.json_decode($notification->user_content,true)[PROFILE_IMAGE] : APPTHA_VGALLERY_BASEURL. "images/channel/".$notification_image;
$userUrl = add_query_arg(array('ukey'=>$notification->user_key),$channelPageLink);
?>
