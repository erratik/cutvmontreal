...
Installing "CUTV Management Plugin" can be done either by searching for "CUTV Management Plugin" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
