...
<div class = "wrap wpvr_wrap" style = "visibility:hidden;">
	...
	<div class = "wpvr_nav_tabs pull-left">
		...
		<div title = "<?php _e( 'Sources & Videos' , WPVR_LANG ); ?>" class = "wpvr_nav_tab pull-left noMargin <?php echo $active[ 'content' ]; ?>" id = "a">
			<i class = "wpvr_tab_icon fa fa-bar-chart"></i><br/>
			<span><?php _e( 'Sources & Videos' , WPVR_LANG ); ?> </span>
		</div>
		
		<div title = "<?php _e( 'Automation Stats' , WPVR_LANG ); ?>" class = "wpvr_nav_tab pull-left noMargin <?php echo $active[ 'automation' ]; ?>" id = "b">
			<i class = "wpvr_tab_icon fa fa-calendar"></i><br/>
			<span><?php _e( 'Automation Stats' , WPVR_LANG ); ?></span>
		</div>
		
		
		<div title = "<?php _e( 'Track Duplicates' , WPVR_LANG ); ?>" class = "wpvr_nav_tab pull-left noMargin <?php echo $active[ 'duplicates' ]; ?>" id = "c">
			<i class = "wpvr_tab_icon fa fa-copy"></i><br/>
			<span><?php _e( 'Track Duplicates' , WPVR_LANG ); ?></span>
		</div>
		
		<?php if( WPVR_ENABLE_DATA_FILLERS === TRUE ) { ?>
			<div title = "<?php _e( 'Data Fillers' , WPVR_LANG ); ?>" class = "wpvr_nav_tab pull-left noMargin <?php echo $active[ 'datafillers' ]; ?>" id = "d">
		...
		<?php if( WPVR_ENABLE_SETTERS === TRUE ) { ?>
			<div title = "<?php _e( 'Admin Actions' , WPVR_LANG ); ?>" class = "wpvr_nav_tab pull-left noMargin <?php echo $active[ 'setters' ]; ?>" id = "e">
			...
			<div id = "dashboard-widgets" class = "metabox-holder">
				...
				<div class = "postbox-container">
					...
					<div id = "" class = "postbox ">
						<h3 class = "hndle"><span> <?php _e( 'YOUR VIDEOS' , WPVR_LANG ); ?> </span></h3>
				...
				<div id = "postbox-container-2" class = "postbox-container">
					<div id = "" class = "meta-box-sortables">
									...
									<div class = "wpvr_graph_wrapper" style = "width:100% !important; height:400px !important;">
										<div class = "wpvr_graph_fact">
											...
											<?php } else { ?>
												...
												<p>
													<a href = "<?php echo $new_source_link; ?>" class = "wpvr_black_button wpvr_submit_button wpvr_graph_button">
														<i class = "fa fa-plus"></i>
						...
						<?php if( $sources_stats[ 'total' ] != 0 ) { ?>
							<div id = "" class = "postbox ">
								<h3 class = "hndle"><span> <?php _e( 'YOUR SOURCES - By Service' , WPVR_LANG ); ?> </span></h3>

								<div class = "inside">
									<div class = "wpvr_widget_pie pull-left">
										<div class = "wpvr_graph_wrapper" style = "width:100% !important;">
											<canvas id = "wpvr_chart_sources_by_services" width = "250" height = "250"></canvas>
										</div>
										<?php //$sources_stats = wpvr_sources_stats( $group = true ); ?>
										<script>
						...
						<?php if( $sources_stats[ 'total' ] != 0 ) { ?>
							<div id = "" class = "postbox ">
								<h3 class = "hndle"><span> <?php _e( 'YOUR SOURCES - By State' , WPVR_LANG ); ?> </span></h3>
						...
						<?php if( $sources_stats[ 'total' ] != 0 ) { ?>
							<div id = "" class = "postbox ">
								<h3 class = "hndle"><span> <?php _e( 'YOUR SOURCES - By Status' , WPVR_LANG ); ?> </span></h3>
		...
		<div id = "" class = "wpvr_nav_tab_content tab_b">
			<div id = "dashboard-widgets" class = "metabox-holder">
				<?php
					...
					$problematic_sources = "";
					foreach ( $security_data as $id => $data ) {
						...
						<div id = "" class = "postbox ">
							...
							<div class = "inside">
								...
								<?php
									...
									if( $wpvr_options[ 'wakeUpHours' ] === FALSE ) $workHours = __( 'All the time' , WPVR_LANG );
									else {
									...
									$cron_data = (array) @json_decode( @file_get_contents( $cron_data_file ) );
									
									if( ! isset( $cron_data[ 'last_exec' ] ) ) $cron_data[ 'last_exec' ] = '';
									if( ! isset( $cron_data[ 'first_exec' ] ) ) $cron_data[ 'first_exec' ] = '';
									if( ! isset( $cron_data[ 'total_exec' ] ) ) $cron_data[ 'total_exec' ] = '';
									
									$date_a = new Datetime( $cron_data[ 'last_exec' ] , new DateTimeZone( $wpvr_options[ 'timeZone' ] ) );
									$date_b = new Datetime( 'now' , new DateTimeZone( $wpvr_options[ 'timeZone' ] ) );
								...
								<div class = "wpvr_automation_status">
									...
									<li>
										<?php _e( 'WP Video Robot is working' , WPVR_LANG ); ?> : <span> <?php echo $workHours; ?></span>
									</li>
									<li>
										<?php _e( 'First Execution' , WPVR_LANG ); ?> :
										<span> 
										<?php
											if( $cron_data[ 'first_exec' ] != '' ) echo $cron_data[ 'first_exec' ];
											else _e( 'Never' , WPVR_LANG );
										?>
										</span>
									</li>
									<li>
										...
										<span><?php
												if( $cron_data[ 'last_exec' ] != '' ) echo $cron_data[ 'last_exec' ];
												else _e( 'Never' , WPVR_LANG );
											?></span>
									</li>
									<?php if( $cron_data[ 'total_exec' ] != '' && $cron_data[ 'total_exec' ] != 0 ) { ?>
										<li>
											<?php _e( 'Cron executed' , WPVR_LANG ); ?> <span> <?php echo wpvr_numberK( $cron_data[ 'total_exec' ] ); ?></span>
									...
									<a
										...
										class = "pull-left wpvr_submit_button wpvr_small"
									>
									...
									<a
										...
										target = "_blank"
										id = "wpvr_trigger_cron"
										class = "pull-right wpvr_submit_button wpvr_small wpvr_trigger_cron wpvr_black_button"
									>
