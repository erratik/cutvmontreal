...
<div class = "wrap wpvr_wrap " style = "display:none;">
	...
	<h2 class = "wpvr_title">
		...
		<?php echo __( 'Manage Licences' , WPVR_LANG ); ?>
	</h2>
		...
		<div id = "dashboard-widgets" class = "metabox-holder">
			...
			<div id = "postbox-container-1" class = "postbox-container">
				<div id = "normal-sortables" class = "meta-box-sortables ui-sortable">
					<div id = "dashboard_right_now" class = "postbox ">
						<h3 class = "hndle">
							<span><?php _e( 'WP VIDEO ROBOT LICENCE' , WPVR_LANG ); ?></span>
								...
								<div class = "wpvr_license">
									...
									<?php if( $is_activated === TRUE ) { ?>
										...
										<button
											...
											class = "wpvr_black_button pull-left wpvr_submit_button wpvr_large"
										...
										<button
											...
											class = "wpvr_red_button pull-right wpvr_submit_button wpvr_large"
											is_demo = "<?php echo WPVR_IS_DEMO ? 1 : 0; ?>"
											>
			...
			<div id = "postbox-container-2" class = "postbox-container">
				<div id = "normal-sortables" class = "meta-box-sortables ui-sortable">
					...
					<div id = "dashboard_right_now" class = "postbox ">
						<h3 class = "hndle"><span><?php _e( 'ADDONS LICENCES' , WPVR_LANG ); ?></span></h3>
