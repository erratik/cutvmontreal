...
$entry_utility .= '<div class="entry-top-utility">';
	if ( 'post' == get_post_type() ) {
		...
		$entry_utility .= '<span class="post_dislikes icon-heart-broken">' . vh_ldc_dislike_counter_p('') . '</span>';
		$entry_utility .= '<span class="post_likes icon-heart">' . vh_ldc_like_counter_p('') . '</span>';
